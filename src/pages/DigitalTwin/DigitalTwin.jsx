...
const generateReport = () => {
  ...
  const reportHTML = `
    ...
    <head>
      <meta charset="UTF-8"/>
      <title>FortiSentinel AI - Incident Report #IR-2024-089241</title>
      <style>
    ...
    <body>
      <div class="header">
        <div class="logo">🛡 FortiSentinel AI</div>
        <div class="report-id">
      ...
      <p style="font-size:12px; color:#888; margin-top:4px;">AI Confidence: 96.4% | Model: FortiSentinel AI XGBoost v3.1</p>
      ...
      <div class="timeline-item"><div class="time-label">08:15 PM</div><div class="time-event">🔒 Transaction BLOCKED automatically by FortiSentinel AI</div></div>
      ...
      <div class="footer">
        Generated by FortiSentinel AI — AI-Powered Banking Cybersecurity Platform &nbsp;|&nbsp;
